...
return [
    ...
    */
    'override' => [
        ...
        'app.locale' => 'app.language',
        'app.fallback_locale' => 'app.language',
        'mail.default' => 'app.mail.mailer',
        'mail.from.name' => 'app.name',
        'mail.from.address' => 'app.mail.from.address',
        'services.mailgun.domain' => 'app.mail.mailgun.domain',
        'services.mailgun.secret' => 'app.mail.mailgun.secret',
    ],
